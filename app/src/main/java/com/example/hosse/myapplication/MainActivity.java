...
public class MainActivity extends AppCompatActivity {
    ...
    public class MyRunnable implements Runnable {
        ...
        public MyRunnable(String opponentAnswer) {
    ...
    public void openResultDialog(){
        ...
        (resultDialog.findViewById(R.id.closePopupConnect)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                versusDialog.dismiss();
            }
    ...
    public void openWinDialog(int initialValue, int finalValue){
        ...
        numberAnimator.animateTextView(initialValue,finalValue,((TextView)winDialog.findViewById(R.id.eloUpdate)));
    ...
    public void openLoseDialog(int initialValue, int finalValue){
        ...
        loseDialog.show();
        NumberAnimator numberAnimator = new NumberAnimator();
        numberAnimator.animateTextView(initialValue,finalValue,((TextView) loseDialog.findViewById(R.id.eloUpdate)));
        elo = finalValue;
        load(ELO_FILE,false);
    ...
    public static class resultTask extends AsyncTask<String,String,String>{
        @Override
